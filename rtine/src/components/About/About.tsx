    ...
    <Link className="card-link" to={"/elengy"}>
      <div className="resume-section">
        ...
        <ul>
          ...
          <li>
            Led the project for six months, conducting client meetings to
            discuss project evolution and demonstrating the application.
          </li>
          <li>
    ...
    <Link className="card-link" to={"/tf1"}>
      <div className="resume-section">
        ...
        <ul>
          ...
          <li>
            Implemented key features, including HTML video manipulation and a
            new form-based page in collaboration with the UX/UI team (Figma).
          </li>
          ...
          <li>
            Contributed to the design system and collaborated with the UX team
            to enhance the component library.
          </li>
          <li>
          ...
          <li>
            Assisted in the initial deployment of the application to early
            users.
          </li>
        </ul>
      </div>
